...
public class MySession extends Session implements Subscriber.VideoListener {

    private static final String LOGTAG = "MySession";
        ...
        public Object instantiateItem(ViewGroup container, int position) {
        	...
        	p.getView().setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View v) {
    				int i = mSubscribersViewContainer.getCurrentItem();
    				MySubscriber sub = mSubscribers.get(i);
    				Toast.makeText(mContext, "Screenshot captured!", Toast.LENGTH_LONG).show();
    				sub.saveScreenshot();
	...
	public void onVideoDisabled(SubscriberKit subscriber) {
		...
		Toast.makeText(mContext, "Poor Connection on Subs", Toast.LENGTH_LONG).show();
		subscriber.setSubscribeToVideo(true);
		Toast.makeText(mContext, "Re-enabling Video Subs", Toast.LENGTH_LONG).show();
